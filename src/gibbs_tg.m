function x = gibbs_tg(mu,sigma,x,a,b)
%Sample a vector x according to a truncated multi-dimensional Gaussian 
%distribution with a Gibbs sampler.
%
%-------------------------------------------------------------------------%
%%
...
% > a, b    bounds of the truncated interval [R,1]
%
%
% Outputs:
...
for r = 1:R
    ...
    x(r) = rtnorm(a(r),b(r),mu_r,sqrt(sigma_r));
    id(r) = true;
end
