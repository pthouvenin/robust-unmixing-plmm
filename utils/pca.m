function [U,Ut,P,Pt,y_bar,Y_proj,d] = pca(Y,K)
...
P = V(:,1:K)';
Pt = V(:,K+1:end)';
% P = D^(-1/2)*(V'); % solves numerical issues if the simplex if stretched in a given direction
                     % significant difference in the amplitude of the singular values
